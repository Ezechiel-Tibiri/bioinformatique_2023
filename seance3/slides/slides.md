...
```bash
tar cvf study-cases.tar --exclude ".git" ~/bioinfo/bioinformatique_2023/data/study-cases/
```
...
unique dans le fichier `~/bioinfo/bioinformatique_2023/data/study-cases/Escherichia_coli/Escherichia_coli_str_k_12_substr_mg1655.ASM584v2.37.chromosome.Chromosome.gff3`
...
```bash
cut -f 9 ~/bioinfo/bioinformatique_2023/data/study-cases/Escherichia_coli/Escherichia_coli_str_k_12_substr_mg1655.ASM584v2.37.chromosome.Chromosome.gff3 | cut -d ";" -f 1 | grep "ID=gene" | sort -u | wc -l
```
